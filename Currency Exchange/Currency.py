...
root.title("Pengchao Currency Exchange")
root.iconbitmap('D:\DevOps\Python\GUI_PYTHON\Python2024\icon.ico')
root.maxsize(600,270)
root.minsize(600,270)


image = Image.open('D:\DevOps\Python\GUI_PYTHON\Python2024\currency.png')
zoom = 0.5
